...
const Gallery = () => {
    ...
    return (
        <>
            ...
            {/* Contenedor con scroll - altura completa */}
            <div className="h-full overflow-y-auto bg-slate-50 dark:bg-slate-900 transition-colors">
                {/* Wrapper que permite que el contenido crezca */}
                <div className="min-h-full flex">
                    {/* Sidebar - Solo desktop (lg+) */}
                    <aside className="hidden lg:flex lg:w-52 xl:w-56 flex-col
                        ...
                        <div>
                            <h3 className="text-xs font-semibold text-gray-400 dark:text-slate-400
                    ...
                    {/* Área principal - sin restricción de altura */}
                    <div
                    ...
                    >
                        ...
                        {/* Grid de imágenes - un poco más pequeñas */}
                        <div
                        ...
                        >
                            {gallery.map((item) => (
                                ...
                                >
                                    ...
                                    <div className="hidden sm:flex absolute inset-0 items-end justify-end p-3
