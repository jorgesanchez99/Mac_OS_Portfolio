        ...
        <div className="max-w-4xl mx-auto space-y-10">
            ...
            <div className="shrink-0">
              <img
                ...
                className="w-24 h-24 md:w-28 md:h-28 rounded-full object-cover shadow-lg
                           ring-4 ring-white border border-gray-200"
              />
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              <h4 className="text-xs md:text-sm font-semibold tracking-[0.18em] uppercase text-slate-500">
                Conecta conmigo
              </h4>
          ...
          {/* Footer info */}
          <footer className="pt-4 border-t border-slate-100 text-xs text-slate-700 flex flex-wrap items-center justify-between gap-2">
