    ...
    <>
      ...
      <div className="px-6 md:px-10 py-8 md:py-10">
        <div className="max-w-4xl mx-auto space-y-10">
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-slate-50">
                  Programador backend y futuro full-stack
                </h3>
              </div>

              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-sm md:text-base max-w-xl">
                Me enfoco en desarrollo backend con Java mientras construyo bases
                sólidas en frontend y herramientas modernas.
                Si quieres colaborar, revisar código o simplemente conectar, aquí tienes mis datos.
              </p>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full border
                           ...
                           transition-all"
              >
                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-sky-50 dark:bg-sky-900/40 text-sky-600 dark:text-sky-300">
                  <Mail size={18} />
                </span>
          ...
          {/* Footer info */}
          <footer className="pt-4 border-t border-slate-100 dark:border-slate-700 text-xs text-slate-700 dark:text-slate-300 flex flex-wrap items-center justify-between gap-2">
